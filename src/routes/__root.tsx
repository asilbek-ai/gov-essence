...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SmartTour 360 — Premium turizm platformasi" },
      { property: "og:description", content: "Virtual 360° sayohatlar, xarita, mehmonxonalar, AI yordamchi va to'liq admin panel." },
